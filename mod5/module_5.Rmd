...
The `(1 | schoolid)` refers to the constant (`1`) and random level 2 explanatory variables (`schoolid`). The constant is an integer greater than or equal to one, with the greater the value the more accurate the estimation of the log--likelihood at the cost of greater computational time.
