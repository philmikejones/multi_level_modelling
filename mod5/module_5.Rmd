...
Likelihood ratio $= 2(`r m_anova$logLik[2]` - `r m_anova$logLik[1]`) = `r 2 * (m_anova$logLik[2] - m_anova$logLik[1])`$ on $`r m_anova$Df[2] - m_anova$Df[1]`$ d.f.

The $p$-value of this likelihood ratio is $`r format_p(m_anova[["Pr(>Chisq)"]][2])`.$
