...
```{r null-summary}
summary(m_null)
mean(m_null@beta) %>% print(., digits = 3)
```
...
The between--school variance (level 2) in attainment is estimated as `r VarCorr(m_null, comp = "Variance", digits = 3)` and the within--school between--student (level 1) variance is...`r stop()`
